...
<div class="table-container">
    ...
    <table id="table-orders">
        ...
        <tr>
            <th>ID</th>
            <th class="references-users">User</th>
            <th data-bind="items" class="references-items">Item</th>
            <th data-calculable="var-1" class="bind-items">Price</th>
            <th class="bind-items">Category</th>
            <th data-calculate="input">Quantity</th>
            <th data-calculable="output">Total</th>
            <th>Action</th>
        </tr>
        </thead>
        <tbody>
        ...
        while($rows = $result->fetch_array(MYSQLI_NUM)){
            ...
            echo "<td><a data-table='orders' data-tag='$id' class='action-delete'>Delete</a>";
            echo "<a data-table='orders' data-tag='$id' class='action-update'>Update</a></td>";
            echo "</tr>";
        }
        ?>
        </tbody>
